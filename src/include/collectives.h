...
#define ALLGATHER_TMA_SLICESTEPS (NCCL_STEPS/32) // [jihwan] For TMA AllGather 
...
#define NCCL_MAX_SLICE_PER_CHUNK 32  // max value for CHUNKSTEPS/SLICESTEPS, must accord with above
#define NCCL_MAX_NET_SIZE (1024*1024*1024L) // Rather than send INT_MAX which is 2G-1, send a power of two.
